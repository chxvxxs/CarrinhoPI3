      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/produtos" className="text-gray-600 hover:text-[#FF6B35] transition-colors flex items-center space-x-1">
              <span>Produtos</span>
            </Link>
            <Link href="/artesaos" className="text-gray-600 hover:text-[#FF6B35] transition-colors flex items-center space-x-1">
              <span>Artesãos</span>
            </Link>
            <Link href="/sobre" className="text-gray-600 hover:text-[#FF6B35] transition-colors flex items-center space-x-1">
              <span>Sobre</span>
            </Link>
            <Link href="/contato" className="text-gray-600 hover:text-[#FF6B35] transition-colors flex items-center space-x-1">
              <span>Contato</span>
            </Link>
          </div>
