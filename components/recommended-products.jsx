    ...
    <div className="bg-white rounded-lg shadow-sm p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {recommendedProducts.map((product) => (
          <div
            key={product.id}
            className="border rounded-lg p-3 hover:shadow-md transition-shadow h-full flex flex-col"
          >
            ...
            <div className="flex-1 flex flex-col">
              <h3 className="font-medium text-gray-800 text-sm line-clamp-2 flex-1">{product.name}</h3>
